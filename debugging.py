...
def main():
    ...
    for idx in range(num_samples_to_check):
        try:
            ...
            # Optionally, visualize the grid maps and images
            # Uncomment the following lines to display images (requires matplotlib)
    ...
    try:
        for batch_idx, batch in enumerate(dataloader):
            ...
            print(f"Batch start positions SE3 shape: {len(batch['start_position_SE3'])}")
